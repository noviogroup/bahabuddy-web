    ...
    <div className={className}>
      ...
      >
        ...
        {moreThanOne && !expanded && (
          <div className="absolute bottom-2 right-2 bg-black/55 text-white text-xs font-medium px-2 py-0.5 rounded-md inline-flex items-center gap-1 backdrop-blur-sm">
