...
export default function ReturnSafetyCard({
  ...
  return (
    <section className="rounded-baha-xl border border-gray-200 bg-white p-5 shadow-sm">
      ...
      <h2 className="mt-2 text-2xl font-bold text-night">Know when to head back.</h2>
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        <div className="rounded-baha-md border border-gray-200 bg-gray-50 p-4">
          ...
          <p className="mt-1 text-lg font-bold text-night">{departureTime || 'Add ship time'}</p>
        </div>
        <div className="rounded-baha-md border border-gray-200 bg-gray-50 p-4">
          <p className="text-xs font-bold uppercase text-gray-400">All aboard</p>
          <p className="mt-1 text-lg font-bold text-night">{allAboardTime || 'Usually before departure'}</p>
        </div>
        <div className="rounded-baha-md border border-gray-200 bg-gray-50 p-4">
          <p className="text-xs font-bold uppercase text-gray-400">Recommended return</p>
          <p className="mt-1 text-lg font-bold text-brand-700">{recommendedReturnTime || '90 min buffer'}</p>
        </div>
        <div className="rounded-baha-md border border-gray-200 bg-gray-50 p-4">
          <p className="text-xs font-bold uppercase text-gray-400">Latest final-stop departure</p>
          <p className="mt-1 text-lg font-bold text-brand-700">{latestFinalStopDeparture || 'Before return buffer'}</p>
        </div>
      </div>
