  ...
  return (
    <div className="flex items-center gap-3 px-5 py-4 md:px-6 md:py-5">
      ...
      <div className="flex-1 min-w-0">
        <h1 className="text-xl md:text-2xl font-bold text-night leading-tight truncate">
          {greeting}, {safeName}
        </h1>
      ...
      <button
        onClick={onBellClick}
        className="relative shrink-0 w-10 h-10 bg-white rounded-full shadow-soft flex items-center justify-center text-gray-500 hover:text-night transition-colors"
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-4 h-4 px-1 bg-coral-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center">
