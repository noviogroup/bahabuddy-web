...
export default function GreetingStrip({
  ...
  return (
    <div className="flex items-center gap-3 px-5 py-4 md:px-6 md:py-5">
      ...
      <button
        onClick={onBellClick}
        className="flex h-11 shrink-0 items-center justify-center gap-1.5 rounded-xl bg-white px-3 text-gray-500 shadow-soft transition-colors hover:text-night focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300 focus-visible:ring-offset-2"
