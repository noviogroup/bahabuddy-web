...
export function StaySearchRailCell({
  ...
  return (
    ...
    >
      <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand-50 text-brand-700" aria-hidden="true">
  ...
  return (
    <div ref={rootRef} className="relative min-w-0">
      ...
      >
        ...
        <span className={cn('inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-200 bg-white text-gray-500 transition-transform', open && 'rotate-180')} aria-hidden="true">
