...
// ─── Hotel Card ───────────────────────────────────────────────────────────────
//
// The previous inline HotelCard implementation has moved to
//   src/components/cards/HotelCard.tsx
// and is dispatched from `RichCardRenderer` above via `HotelCardAdapter`.
// The new card supports inline expand, photo galleries, top-review
// social proof, and a contact action row — see that file for details.

// ─── Restaurant Card ──────────────────────────────────────────────────────────

function RestaurantCard_removed_see_cards_folder() { return null }

// ─── Activity Card ────────────────────────────────────────────────────────────

function ActivityCard_removed_see_cards_folder() { return null }
 ...
 */
function FlightCard_removed_see_cards_folder() { return null }

// ─── Day Plan Card ────────────────────────────────────────────────────────────

function DayPlanCard_removed_see_cards_folder() { return null }
 ...
 */
function SummaryCard_removed_see_cards_folder() { return null }

// ─── Map Card ─────────────────────────────────────────────────────────────────

function MapCard_removed_see_cards_folder() { return null }
 ...
 * `islandNameToSlug`.
 */
function DestinationCard_removed_see_cards_folder() { return null }
