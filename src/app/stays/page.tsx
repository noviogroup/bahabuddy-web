...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Book Bahamas Hotels & Stays | Baha Buddy',
    description:
      'Find and book the perfect Bahamas stay — hotels, villas, and apartments with live rates.',
  },
}
      ...
      <div className="bg-gradient-to-br from-brand-600 to-brand-500 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">
            {activeIsland
              ? `Stays in ${activeIsland}`
              : 'Find Your Perfect Bahamas Stay'}
          </h1>
          <p className="text-white/80 text-lg max-w-xl mx-auto">
            Browse hotels, villas, and apartments across the Bahamas — check live availability and rates.
          </p>
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mt-16 bg-gradient-to-r from-brand-600 to-brand-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-2">
            Let Baha Buddy find your perfect stay
          </h2>
