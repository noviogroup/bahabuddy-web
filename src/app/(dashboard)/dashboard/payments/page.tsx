  ...
  return (
    <div className="max-w-3xl mx-auto px-5 md:px-6 py-6 pb-10">
      <div className="mb-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm md:p-8">
        <p className="inline-flex rounded-full bg-gray-100 px-3 py-1 text-xs font-bold uppercase tracking-wide text-charcoal">Payments</p>
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-night md:text-4xl">Your Baha Buddy payments</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          <p className="text-xs font-bold uppercase tracking-wide text-charcoal">Total paid</p>
          <p className="mt-2 text-2xl font-extrabold text-night">{money(totalPaid)}</p>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          <p className="text-xs font-bold uppercase tracking-wide text-charcoal">Orders</p>
