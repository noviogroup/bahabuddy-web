  ...
  return (
    <div className="max-w-3xl mx-auto px-5 md:px-6 py-6 pb-10">
      ...
      <div className="rounded-3xl bg-white border border-sand-200 shadow-card overflow-hidden">
        <div className="bg-gradient-brand text-white p-6 md:p-8">
          <p className="inline-flex rounded-full bg-white/15 px-3 py-1 text-xs font-bold uppercase tracking-wide backdrop-blur">Receipt</p>
          <h1 className="mt-4 text-3xl md:text-4xl font-extrabold tracking-tight">{receiptNumber}</h1>
          <p className="mt-2 text-brand-50">Baha Buddy Concierge Payment</p>
        </div>
