          ...
          <div className="mt-2 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm font-semibold leading-6 text-gray-500">
                Search live fares, review traveler details, and keep the booking with your trip.
              </p>
            </div>
            <div className="rounded-full border border-gray-200 bg-white px-4 py-2 text-xs font-bold uppercase text-brand-700">
              Live fares
            </div>
          </div>
        </div>
