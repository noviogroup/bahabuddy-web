...
const FALLBACK_PLACES: Place[] = [
  { id: '1', name: 'Nassau Fish Fry', category: 'Dining', island: 'Nassau', description: "Arawak Cay's famous strip of outdoor restaurants — the best conch salad and local Bahamian food in Nassau.", image_url: BahaImages.nassau, tags: ['Local food', 'Conch', 'Nightlife'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '2', name: 'Swimming Pigs Beach', category: 'Activity', island: 'Exuma', description: 'Big Major Cay — where wild pigs swim out to greet boats. The most famous and photogenic experience in the Bahamas.', image_url: BahaImages.exumas, tags: ['Wildlife', 'Boat trip', 'Photography'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '3', name: "Pink Sands Beach", category: 'Beach', island: 'Harbour Island', description: "Three miles of world-famous pink sand — the colour comes from microscopic coral insects. Consistently ranked among the world's best beaches.", image_url: BahaImages.bahamasLifestyle, tags: ['Pink sand', 'Swimming', 'Romantic'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '4', name: "Dean's Blue Hole", category: 'Activity', island: 'Long Island', description: "The world's deepest known blue hole at 663 feet. A surreal, perfectly circular pool of brilliant blue in a limestone bay.", image_url: BahaImages.eleuthera, tags: ['Diving', 'Snorkeling', 'Unique'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '5', name: 'Atlantis Resort', category: 'Hotel', island: 'Nassau', description: "The iconic mega-resort on Paradise Island — waterpark, casino, multiple beaches, and the famous Aquaventure water rides.", image_url: BahaImages.snorkeling, tags: ['Resort', 'Family', 'Casino'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '6', name: 'Glass Window Bridge', category: 'Nature', island: 'Eleuthera', description: "A narrow land bridge where the deep Atlantic Ocean meets the calm turquoise Bight of Eleuthera — a dramatic natural sight.", image_url: BahaImages.eleuthera, tags: ['Scenic', 'Photo spot', 'Nature'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '7', name: 'Compass Point Beach Resort', category: 'Hotel', island: 'Nassau', description: "Iconic colourful huts overlooking Love Beach — a quirky, intimate boutique resort a short drive from Nassau.", image_url: BahaImages.nassau, tags: ['Boutique', 'Colorful', 'Romantic'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '8', name: 'Exuma Cays Land and Sea Park', category: 'Nature', island: 'Exuma', description: 'The Western Hemisphere\'s first land and sea park — 176 square miles of pristine reefs, sandbars, and sea life.', image_url: BahaImages.exumas, tags: ['Marine park', 'Snorkeling', 'Remote'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '9', name: 'Fort Charlotte', category: 'Culture', island: 'Nassau', description: "Nassau's largest fort, built in 1788 — panoramic harbour views, drawbridge, dungeons, and fascinating colonial history.", image_url: BahaImages.nassau, tags: ['History', 'Views', 'Walking tour'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '10', name: 'Graycliff Restaurant', category: 'Restaurant', island: 'Nassau', description: "Award-winning fine dining in a 250-year-old Georgian colonial mansion — one of the Caribbean's best wine cellars and cigar factory.", image_url: BahaImages.nassau, tags: ['Fine dining', 'Wine', 'Historic'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '11', name: 'Andros Barrier Reef', category: 'Water Activity', island: 'Andros', description: "The third-largest barrier reef in the world — extraordinary wall dives, blue holes, and some of the least-dived water in the Caribbean.", image_url: BahaImages.andros, tags: ['Diving', 'Snorkeling', 'Reef'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
  { id: '12', name: 'Bimini Big Game Club Resort', category: 'Hotel', island: 'Bimini', description: "The legendary deep-sea fishing club where Hemingway wrote parts of The Old Man and the Sea. World-class marina and sport fishing.", image_url: BahaImages.bimini, tags: ['Fishing', 'Historic', 'Marina'], rating: null, review_count: null, amenities: null, price_range: null, short_description: null, enriched_at: null },
]
...
async function getPlaces(): Promise<Place[] | null> {
  try {
    ...
    const { data, error } = await supabase
      ...
      .select('id, name, category, island, description, image_url, tags, rating, review_count, amenities, price_range, short_description, enriched_at')
