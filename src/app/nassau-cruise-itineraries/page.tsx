  ...
  return (
    <main className="min-h-screen bg-white">
      <CompactPageHeader
        ...
        actions={(
          <>
            <Link href="/nassau-cruise-day-planner" className="rounded-full bg-brand-600 px-4 py-2 text-sm font-extrabold text-white transition-colors hover:bg-brand-700">
              View planner
            </Link>
